...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    // MARK: - create elements on screen
    ...
    func makeBall(at location: CGPoint){
        let colorNames = ["Blue", "Yellow", "Purple", "Grey", "Red", "Cyan", "Green"]
        let ball = SKSpriteNode(imageNamed: "ball\(colorNames[Int.random(in: 0...colorNames.count-1)])")
        let ballLocation = CGPoint(x: location.x, y: 750)
